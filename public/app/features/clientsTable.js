...
export class ClientsTable {
  ...
  applyFilters(clients) {
    // ...
    const connectionType = c.connectionType || ''; // Antigo distribuidora
    const projeto = c.projeto || '';

    const matchesSearch = !search ||
      // ... outros campos ...
      connectionType.toLowerCase().includes(search) || // Busca por "Bifásico", "Trifásico"
      projeto.toLowerCase().includes(search);          // Busca por "Consorcio Era Verde"
    // ...
